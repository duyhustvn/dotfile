...
DEFAULT_PROXY="http://192.168.5.8:3128"
DEFAULT_NO_PROXY="localhost,127.0.0.1,*.viettelcybersecurity.com,*.viettelcyber.com"
...
[http "https://gitlab.viettelcyber.com"]
	proxy = 
	sslVerify = false

[https "https://gitlab.viettelcyber.com"]
	proxy = 
	sslVerify = false
EOF
